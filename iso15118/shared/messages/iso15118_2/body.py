...
from iso15118.shared.messages.iso15118_2.datatypes import (
    ...
    ChargeService,
    Service,
    ChargingSession, SAScheduleTuple, ProfileEntry, EMAID)
...
class AuthorizationReq(BodyBase):
    ...
    gen_challenge: bytes = Field(None, min_length=16, max_length=16,
                                 alias='GenChallenge')
    ...
    def both_fields_set_or_unset(cls, values):
        ...
        if (_id and not gen_challenge) or (not _id and gen_challenge):
            raise ValueError("Fields 'id' and 'gen_challenge' must either both "
...
class CertificateInstallationReq(BodyBase):
    ...
    oem_provisioning_cert: bytes = Field(..., max_length=800,
                                         alias='OEMProvisioningCert')
    root_cert_ids: List[RootCertificateID] = \
...
class CertificateInstallationRes(Response):
    ...
    cps_cert_chain: CertificateChain = \
        Field(..., alias='SAProvisioningCertificateChain')
    contract_cert_chain: CertificateChain = \
        Field(..., alias='ContractSignatureCertChain')
    encrypted_private_key: EncryptedPrivateKey \
        = Field(..., alias='ContractSignatureEncryptedPrivateKey')
...
class CertificateUpdateReq(BodyBase):
    ...
    list_of_root_cert_ids: List[RootCertificateID] = \
        Field(..., alias='ListOfRootCertificateIDs')
...
class ChargeParameterDiscoveryReq(BodyBase):
    ...
    max_entries_sa_schedule_tuple: int = \
        Field(None, ge=0, le=65535, alias='MaxEntriesSAScheduleTuple')
    requested_energy_mode: EnergyTransferModeEnum = \
        Field(..., alias='RequestedEnergyTransferMode')
    ac_ev_charge_parameter: ACEVChargeParameter = \
        Field(None, alias='AC_EVChargeParameter')
    dc_ev_charge_parameter: DCEVChargeParameter = \
        Field(None, alias='DC_EVChargeParameter')
    ...
    def either_ac_or_dc_charge_params(cls, values):
        ...
        # pylint: disable=no-self-argument
        # pylint: disable=no-self-use
        if one_field_must_be_set(['ac_ev_charge_parameter',
    ...
    def requested_energy_mode_must_match_charge_parameter(cls, values):
        ...
        if ("AC_" in requested_energy_mode and dc_params) or \
           ("DC_" in requested_energy_mode and ac_params):
            raise ValueError("Wrong charge parameters for requested energy "
...
class ChargeParameterDiscoveryRes(Response):
    ...
    evse_processing: EVSEProcessing = Field(..., alias='EVSEProcessing')
    sa_schedule_list: List[SAScheduleTuple] = Field(None, max_items=3,
                                                    alias='SAScheduleList')
    ac_charge_parameter: ACEVSEChargeParameter = \
        Field(None, alias='AC_EVSEChargeParameter')
    dc_charge_parameter: DCEVSEChargeParameter = \
        Field(None, alias='DC_EVSEChargeParameter')
...
class CurrentDemandReq(BodyBase):
    ...
    ev_max_voltage_limit: PVEVMaxVoltageLimit = \
        Field(None, alias='EVMaximumVoltageLimit')
    ev_max_current_limit: PVEVMaxCurrentLimit = \
        Field(None, alias='EVMaximumCurrentLimit')
    ev_max_power_limit: PVEVMaxPowerLimit = \
    ...
    remaining_time_to_full_soc: PVRemainingTimeToFullSOC = \
        Field(None, alias='RemainingTimeToFullSoC')
    remaining_time_to_bulk_soc: PVRemainingTimeToBulkSOC = \
        Field(None, alias='RemainingTimeToBulkSoC')
...
class CurrentDemandRes(Response):
    ...
    evse_present_voltage: PVEVSEPresentVoltage = \
        Field(..., alias='EVSEPresentVoltage')
    evse_present_current: PVEVSEPresentCurrent = \
        Field(..., alias='EVSEPresentCurrent')
    evse_current_limit_achieved: bool = \
        Field(..., alias='EVSECurrentLimitAchieved')
    evse_voltage_limit_achieved: bool = \
        Field(..., alias='EVSEVoltageLimitAchieved')
    evse_power_limit_achieved: bool = \
        Field(..., alias='EVSEPowerLimitAchieved')
    evse_max_voltage_limit: PVEVSEMaxVoltageLimit = \
        Field(None, alias='EVSEMaximumVoltageLimit')
    evse_max_current_limit: PVEVSEMaxCurrentLimit = \
        Field(None, alias='EVSEMaximumCurrentLimit')
    evse_max_power_limit: PVEVSEMaxPowerLimit = \
        Field(None, alias='EVSEMaximumPowerLimit')
...
class PaymentServiceSelectionReq(BodyBase):
    ...
    """
    selected_auth_option: AuthEnum = \
        Field(..., alias='SelectedPaymentOption')
    selected_service_list: SelectedServiceList = \
        Field(..., alias='SelectedServiceList')
...
class PowerDeliveryReq(BodyBase):
    ...
    # XSD type unsignedByte with value range [1..255]
    sa_schedule_tuple_id: int = Field(..., ge=1, le=255, alias='SAScheduleTupleID')
    charging_profile: List[ProfileEntry] = Field(None, max_items=24,
                                                 alias='ChargingProfile')
    dc_ev_power_delivery_parameter: DCEVPowerDeliveryParameter \
        = Field(None, alias='DC_EVPowerDeliveryParameter')
...
class ServiceDetailRes(Response):
    ...
    service_parameter_list: ServiceParameterList = \
        Field(None, alias='ServiceParameterList')
...
class ServiceDiscoveryRes(Response):
    ...
    auth_option_list: List[AuthOptions] = \
        Field(..., min_items=1, max_items=2, alias='PaymentOptionList')
    ...
    def check_sessionid_is_hexbinary(cls, value):
        ...
        try:
            ...
            raise ValueError(
                ...
                f"hexadecimal representation of max 6 bytes)") from exc
...
class Body(BaseModel):
    ...
    service_discovery_req: ServiceDiscoveryReq = \
        Field(None, alias='ServiceDiscoveryReq')
    service_discovery_res: ServiceDiscoveryRes = \
        Field(None, alias='ServiceDiscoveryRes')
    ...
    charge_parameter_discovery_req: ChargeParameterDiscoveryReq = \
        Field(None, alias='ChargeParameterDiscoveryReq')
    charge_parameter_discovery_res: ChargeParameterDiscoveryRes = \
        Field(None, alias='ChargeParameterDiscoveryRes')
    ...
    charging_status_req: ChargingStatusReq = \
        Field(None, alias='ChargingStatusReq')
    charging_status_res: ChargingStatusRes = \
        Field(None, alias='ChargingStatusRes')
    ...
    metering_receipt_req: MeteringReceiptReq = \
        Field(None, alias='MeteringReceiptReq')
    metering_receipt_res: MeteringReceiptRes = \
        Field(None, alias='MeteringReceiptRes')
    welding_detection_req: WeldingDetectionReq = \
        Field(None, alias='WeldingDetectionReq')
    welding_detection_res: WeldingDetectionRes = \
        Field(None, alias='WeldingDetectionRes')
