...
class PnCAuthSetupResParams(BaseModel):
    """See section 8.3.4.3.2.1 in ISO 15118-20"""
    gen_challenge: bytes = Field(..., min_length=16, max_length=16,
                                 alias='GenChallenge')
    supported_providers: List[ProviderID] = Field(None, max_items=128,
                                                  alias='SupportedProviders')
...
class AuthorizationSetupRes(V2GResponse):
    ...
    auth_services: List[AuthEnum] = \
        Field(..., max_items=2, alias='AuthorizationServices')
    cert_install_service: bool = \
        Field(..., alias='CertificateInstallationService')
    pnc_as_res: PnCAuthSetupResParams = \
        Field(None, alias='PnC_ASResAuthorizationMode')
    eim_as_res: EIMAuthSetupResParams = \
        Field(None, alias='EIM_ASResAuthorizationMode')
    ...
    def at_least_one_authorization_mode(cls, values):
        ...
        if one_field_must_be_set(['pnc_as_res', 'PnC_ASResAuthorizationMode',
                                  'eim_as_res', 'EIM_ASResAuthorizationMode'],
                                 values,
                                 False):
            return values
...
class PnCAuthReqParams(BaseModel):
    ...
    contract_cert_chain: ContractCertificateChain = \
        Field(..., alias='ContractCertificateChain')
...
class AuthorizationReq(V2GRequest):
    ...
    selected_auth_service: AuthEnum = \
        Field(..., alias='SelectedAuthorizationService')
    pnc_params: PnCAuthReqParams = \
        Field(None, alias='PnC_AReqAuthorizationMode')
    eim_params: EIMAuthReqParams = \
        Field(None, alias='EIM_AReqAuthorizationMode')
    ...
    def at_least_one_authorization_mode(cls, values):
        ...
        # pylint: disable=no-self-argument
        # pylint: disable=no-self-use
        if one_field_must_be_set(['pnc_params', 'PnC_AReqAuthorizationMode',
                                  'eim_params', 'EIM_AReqAuthorizationMode'],
                                 values,
                                 False):
            return values
...
class ServiceDiscoveryReq(V2GRequest):
    ...
    supported_service_ids: ServiceIdList = \
        Field(..., alias='SupportedServiceIDs')
...
class ServiceDiscoveryRes(V2GResponse):
    ...
    service_renegotiation_supported: bool = \
        Field(..., alias='ServiceRenegotiationSupported')
    energy_transfer_service_list: List[Service] = \
        Field(..., max_items=8, alias='EnergyTransferServiceList')
...
class ServiceParameterList(BaseModel):
    ...
    parameter_set: List[ParameterSet] = Field(..., max_items=32,
                                              alias='ParameterSet')
...
class ServiceDetailRes(V2GResponse):
    ...
    service_parameter_list: ServiceParameterList = \
        Field(..., alias='ServiceParameterList')
...
class ServiceSelectionReq(V2GRequest):
    ...
    selected_energy_transfer_service: SelectedService = \
        Field(..., alias='SelectedEnergyTransferService')
    selected_vas_list: SelectedService = \
        Field(None, alias='SelectedVASList')
...
class EVPowerScheduleEntryList(BaseModel):
    ...
    ev_power_schedule_entry: List[EVPowerScheduleEntry] = \
        Field(..., max_items=1024, alias='EVPowerScheduleEntry')
...
class EVPowerSchedule(BaseModel):
    ...
    ev_power_schedule_entries: EVPowerScheduleEntryList = \
        Field(..., alias='EVPowerScheduleEntries')
...
class EVPriceRuleStack(BaseModel):
    ...
    duration: int = Field(..., alias='Duration')
    ev_price_rule: List[EVPriceRule] = Field(..., max_items=8,
                                             alias='EVPriceRule')


class EVPriceRuleStackList(BaseModel):
    """See section 8.3.5.3.46 in ISO 15118-20"""
    ev_price_rule_stack: List[EVPriceRuleStack] = Field(..., max_items=1024,
...
class EVAbsolutePriceSchedule(BaseModel):
    ...
    ev_price_rule_stacks: EVPriceRuleStackList = \
        Field(..., alias='EVPriceRuleStacks')
...
class EVEnergyOffer(BaseModel):
    ...
    ev_absolute_price_schedule: EVAbsolutePriceSchedule = \
        Field(..., alias='EVAbsolutePriceSchedule')
...
class ScheduledScheduleExchangeReqParams(BaseModel):
    ...
    ev_target_energy_request: RationalNumber = \
        Field(None, alias='EVTargetEnergyRequest')
    ev_max_energy_request: RationalNumber = \
        Field(None, alias='EVMaximumEnergyRequest')
    ev_min_energy_request: RationalNumber = \
        Field(None, alias='EVMinimumEnergyRequest')
    ev_energy_offer: EVEnergyOffer = \
        Field(None, alias='EVEnergyOffer')
...
class DynamicScheduleExchangeReqParams(BaseModel):
    ...
    ev_target_energy_request: RationalNumber = \
        Field(..., alias='EVTargetEnergyRequest')
    ev_max_energy_request: RationalNumber = \
        Field(..., alias='EVMaximumEnergyRequest')
    ev_min_energy_request: RationalNumber = \
        Field(..., alias='EVMinimumEnergyRequest')


class ScheduleExchangeReq(V2GRequest):
    """See section 8.3.4.3.7.2 in ISO 15118-20"""
    max_supporting_points: int = Field(..., ge=12, le=1024,
                                       alias='MaximumSupportingPoints')
    scheduled_se_req: ScheduledScheduleExchangeReqParams = \
        Field(..., alias='Scheduled_SEReqControlMode')
    dynamic_se_req: DynamicScheduleExchangeReqParams = \
        Field(..., alias='Dynamic_SEReqControlMode')
    ...
    def either_scheduled_or_dynamic(cls, values):
        ...
        # pylint: disable=no-self-argument
        # pylint: disable=no-self-use
        if one_field_must_be_set(['scheduled_se_req', 'Scheduled_SEReqControlMode',
                                  'dynamic_se_req', 'Dynamic_SEReqControlMode'],
                                 values,
                                 True):
            return values
...
class PowerScheduleEntryList(BaseModel):
    ...
    power_schedule_entry: List[PowerScheduleEntry] = \
        Field(..., max_items=1024, alias='PowerScheduleEntry')


class PowerSchedule(BaseModel):
    """See section 8.3.5.3.18 in ISO 15118-20"""
    time_anchor: int = Field(..., alias='TimeAnchor')
    available_energy: RationalNumber = \
        Field(None, alias='AvailableEnergy')
    power_tolerance: RationalNumber = \
        Field(None, alias='PowerTolerance')
    power_schedule_entries: PowerScheduleEntryList = \
        Field(..., alias='PowerScheduleEntries')


class PriceSchedule(BaseModel):
    """See sections 8.3.5.3.49 and 8.3.5.3.62 in ISO 15118-20"""
    time_anchor: int = Field(..., alias='TimeAnchor')
    price_schedule_id: int = Field(..., ge=1, le=INT_32_MAX,
                                   alias='PriceScheduleID')
    price_schedule_description: str = Field(None, max_length=160,
                                            alias='PriceScheduleDescription')
...
class PriceLevelScheduleEntryList(BaseModel):
    ...
    entry: List[PriceLevelScheduleEntry] = \
        Field(..., max_items=1024, alias='PriceLevelScheduleEntry')
...
class PriceLevelSchedule(PriceSchedule):
    ...
    schedule_entries: PriceLevelScheduleEntryList = \
        Field(..., alias='PriceLevelScheduleEntries')
...
class PriceRule(BaseModel):
    ...
    carbon_dioxide_emission: int = \
        Field(None, alias='CarbonDioxideEmission')
    # XSD type unsignedByte with value range [0..255]
    renewable_energy_percentage: int = \
        Field(None, ge=0, le=255, alias='RenewableGenerationPercentage')
    power_range_start: RationalNumber = Field(..., alias='PowerRangeStart')


class PriceRuleStack(BaseModel):
    """See section 8.3.5.3.53 in ISO 15118-20"""
    price_rule_stack_id: int = Field(..., ge=1, le=INT_32_MAX,
                                     alias='PriceRuleStackID')
    duration: int = Field(..., alias='Duration')
...
class PriceRuleStackList(BaseModel):
    ...
    price_rule_stack: List[PriceRuleStack] = \
        Field(..., max_items=1024, alias='PriceRuleStack')


class OverstayRule(BaseModel):
    """See section 8.3.5.3.56 in ISO 15118-20"""
    overstay_rule_id: int = Field(..., ge=1, le=INT_32_MAX,
                                  alias='OverstayRuleID')
    overstay_rule_description: str = Field(None, max_length=160,
                                           alias='OverstayRuleDescription')
...
class OverstayRuleList(BaseModel):
    ...
    overstay_rule_list_id: int = Field(..., ge=1, le=INT_32_MAX,
                                       alias='OverstayRuleListID')
    overstay_time_threshold: int = \
        Field(None, alias='OverstayTimeThreshold')
    overstay_power_threshold: RationalNumber = \
        Field(None, alias='OverstayPowerThreshold')
    overstay_rule: List[OverstayRule] = Field(..., max_items=5,
                                              alias='OverstayRule')
...
class AdditionalServiceList(BaseModel):
    ...
    additional_service: List[AdditionalService] = \
        Field(..., max_items=5, alias='AdditionalService')
...
class AbsolutePriceSchedule(PriceSchedule):
    ...
    overstay_rules: OverstayRuleList = \
        Field(None, alias='OverstayRules')
    additional_selected_services: AdditionalServiceList = \
        Field(None, alias='AdditionalSelectedServices')
...
class ChargingSchedule(BaseModel):
    ...
    price_level_schedule: PriceLevelSchedule = \
        Field(None, alias='PriceLevelSchedule')
    absolute_price_schedule: AbsolutePriceSchedule = \
        Field(None, alias='AbsolutePriceSchedule')
    ...
    def either_price_levels_or_absolute_prices(cls, values):
        ...
        # pylint: disable=no-self-argument
        # pylint: disable=no-self-use
        if one_field_must_be_set(['price_level_schedule',
                                  'PriceLevelSchedule',
...
class ScheduleTuple(BaseModel):
    ...
    discharging_schedule: DischargingSchedule = \
        Field(..., alias='DischargingSchedule')


class ScheduledScheduleExchangeResParams(BaseModel):
    """See section 8.3.5.3.16 in ISO 15118-20"""
    schedule_tuple: List[ScheduleTuple] = \
        Field(..., max_items=3, alias='ScheduleTuple')
...
class ScheduledEVPowerProfile(BaseModel):
    """See section 8.3.5.3.12 in ISO 15118-20"""
    selected_schedule_tuple_id: int = \
        Field(..., ge=1, le=INT_32_MAX, alias='SelectedScheduleTupleID')
    power_tolerance_acceptance: PowerToleranceAcceptance = \
        Field(..., alias='PowerToleranceAcceptance')
...
class EVPowerProfile(BaseModel):
    ...
    time_anchor: int = Field(..., alias='TimeAnchor')
    ev_power_profile_entries: EVPowerProfileEntryList = \
        Field(..., alias='EVPowerProfileEntries')
    scheduled_ev_power_profile: \
        ScheduledEVPowerProfile = \
        Field(None, alias='Scheduled_EVPPTControlMode')
    dynamic_ev_power_profile: \
        DynamicEVPowerProfile = \
        Field(None, alias='Dynamic_EVPPTControlMode')
    ...
    def either_scheduled_or_dynamic(cls, values):
        ...
        # pylint: disable=no-self-argument
        # pylint: disable=no-self-use
        if one_field_must_be_set(['scheduled_ev_power_profile',
...
class PowerDeliveryReq(V2GRequest):
    ...
    bpt_channel_selection: ChannelSelection = Field(None,
                                                    alias='BPT_ChannelSelection')
...
class ScheduledSignedMeterData(BaseModel):
    ...
    selected_schedule_tuple_id: int = Field(..., ge=1, le=INT_32_MAX,
                                            alias='SelectedScheduleTupleID')
...
class SignedMeteringData(BaseModel):
    ...
    scheduled_smart_meter_data: ScheduledSignedMeterData = \
        Field(None, alias='Scheduled_SMDTControlMode')
    dynamic_smart_meter_data: DynamicSignedMeterData = \
        Field(None, alias='Dynamic_SMDTControlMode')
    ...
    def either_scheduled_or_dynamic(cls, values):
        ...
        # pylint: disable=no-self-argument
        # pylint: disable=no-self-use
        if one_field_must_be_set(['scheduled_smart_meter_data',
...
class MeteringConfirmationReq(V2GRequest):
    ...
    signed_metering_data: SignedMeteringData = \
        Field(..., alias='SignedMeteringData')
...
class SessionStopReq(V2GRequest):
    ...
    ev_termination_code: str = Field(..., max_length=80,
                                     alias='EVTerminationCode')
    ev_termination_explanation: str = Field(..., max_length=160,
...
class CertificateInstallationReq(V2GRequest):
    ...
    oem_prov_cert_chain: SignedCertificateChain = \
        Field(..., alias='OEMProvisioningCertificateChain')
    list_of_root_cert_ids: List[RootCertificateID] = \
        Field(..., max_items=20, alias='ListOfRootCertificateIDs')
    # XSD type unsignedShort (16 bit integer) with value range [0..65535]
    max_contract_cert_chains: int = \
        Field(..., ge=0, le=65535, alias='MaximumContractCertificateChains')
    prioritized_emaids: List[EMAID] = \
        Field(None, max_items=8, alias='PrioritizedEMAIDs')
...
class SignedInstallationData(BaseModel):
    ...
    secp521_encrypted_private_key: bytes = \
        Field(None, min_length=94, max_length=94,
              alias='SECP521_EncryptedPrivateKey')
    x448_encrypted_private_key: bytes \
        = Field(None, min_length=84, max_length=84,
                alias='X448_EncryptedPrivateKey')
    tpm_encrypted_private_key: bytes \
        = Field(None, min_length=209, max_length=209,
                alias='TPM_EncryptedPrivateKey')
    ...
    def one_encryption_mode(cls, values):
        ...
        # pylint: disable=no-self-argument
        # pylint: disable=no-self-use
        if one_field_must_be_set(['secp521_encrypted_private_key',
...
class CertificateInstallationRes(V2GResponse):
    ...
    cps_certificate_chain: CertificateChain = \
        Field(..., alias='CPSCertificateChain')
    signed_installation_data: SignedInstallationData = \
        Field(..., alias='SignedInstallationData')
    # XSD type unsignedByte with value range [0..255]
    remaining_contract_cert_chains: int = \
        Field(..., ge=0, le=255, alias='RemainingContractCertificateChains')
...
class VehicleCheckOutRes(V2GResponse):
    ...
    evse_check_out_status: EVSECheckOutStatus = \
        Field(..., alias='EVSECheckOutStatus')
