...
from iso15118.shared.messages.iso15118_20.ac import (ACChargeParameterDiscoveryRes,
...
from iso15118.shared.messages.iso15118_20.dc import (BPTDCChargeParameterDiscoveryResParams,
...
class EVSEDataContext:
    ...
    def _update_common_ac_charge_parameters_v20(
        ...
        ac_rated_limits.max_charge_power = params.evse_max_charge_power.get_decimal_value() # noqa: E501
        if params.evse_max_charge_power_l2:
            ac_rated_limits.max_charge_power_l2 = params.evse_max_charge_power_l2.get_decimal_value() # noqa: E501
        if params.evse_max_charge_power_l3:
            ac_rated_limits.max_charge_power_l3 = params.evse_max_charge_power_l3.get_decimal_value()
        ac_rated_limits.min_charge_power = params.evse_min_charge_power.get_decimal_value() # noqa: E501
        if params.evse_min_charge_power_l2:
            ac_rated_limits.min_charge_power_l2 = params.evse_min_charge_power_l2.get_decimal_value() # noqa: E501
        if params.evse_min_charge_power_l3:
            ac_rated_limits.min_charge_power_l3 = params.evse_min_charge_power_l3.get_decimal_value() # noqa: E501
        self.nominal_frequency = params.evse_nominal_frequency.get_decimal_value() # noqa: E501
        if params.max_power_asymmetry:
            self.max_power_asymmetry = params.max_power_asymmetry.get_decimal_value() # noqa: E501
        if params.evse_power_ramp_limit:
            self.power_ramp_limit = params.evse_power_ramp_limit.get_decimal_value() # noqa: E501
        if params.evse_present_active_power:
            self.present_active_power = params.evse_present_active_power.get_decimal_value() # noqa: E501
        if params.evse_present_active_power_l2:
            self.present_active_power_l2 = params.evse_present_active_power_l2.get_decimal_value() # noqa: E501
        if params.evse_present_active_power_l3:
            self.present_active_power_l3 = params.evse_present_active_power_l3.get_decimal_value() # noqa: E501
    ...
    def _update_acbpt_charge_parameters_v20(
        ...
        ac_rated_limits.max_discharge_power = params.evse_max_discharge_power.get_decimal_value() # noqa: E501
        if params.evse_max_discharge_power_l2:
            ac_rated_limits.max_discharge_power_l2 = params.evse_max_discharge_power_l2.get_decimal_value() # noqa: E501
        if params.evse_max_discharge_power_l3:
            ac_rated_limits.max_discharge_power_l3 = params.evse_max_discharge_power_l3.get_decimal_value() # noqa: E501
        ac_rated_limits.min_discharge_power = params.evse_min_discharge_power.get_decimal_value() # noqa: E501
        if params.evse_min_discharge_power_l2:
            ac_rated_limits.min_discharge_power_l2 = params.evse_min_discharge_power_l2.get_decimal_value() # noqa: E501
        if params.evse_min_discharge_power_l3:
            ac_rated_limits.min_discharge_power_l3 = params.evse_min_discharge_power_l3.get_decimal_value() # noqa: E501
    ...
    def _update_common_dc_charge_parameters_v20(
        ...
        dc_rated_limits.max_charge_power = params.evse_max_charge_power.get_decimal_value() # noqa: E501
        dc_rated_limits.min_charge_power = params.evse_min_charge_power.get_decimal_value() # noqa: E501
        dc_rated_limits.max_charge_current = params.evse_max_charge_current.get_decimal_value() # noqa: E501
        dc_rated_limits.min_charge_current = params.evse_min_charge_current.get_decimal_value() # noqa: E501
        dc_rated_limits.max_voltage = params.evse_max_voltage.get_decimal_value() # noqa: E501
        dc_rated_limits.min_voltage = params.evse_min_voltage.get_decimal_value() # noqa: E501
        if params.evse_power_ramp_limit:
            self.power_ramp_limit = params.evse_power_ramp_limit.get_decimal_value() # noqa: E501
    ...
    def _update_dcbpt_charge_parameters_v20(
        ...
        dc_rated_limits.max_discharge_power = params.evse_max_discharge_power.get_decimal_value() # noqa: E501
        dc_rated_limits.min_discharge_power = params.evse_min_discharge_power.get_decimal_value() # noqa: E501
        dc_rated_limits.max_discharge_current = params.evse_max_discharge_current.get_decimal_value() # noqa: E501
        dc_rated_limits.min_discharge_current = params.evse_min_discharge_current.get_decimal_value() # noqa: E501
