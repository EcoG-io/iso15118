...
from iso15118.shared.messages.iso15118_2.datatypes import DCEVSEStatus, \
    IsolationLevel, DCEVSEStatusCode, ACEVSEStatus, PVEVSEPresentVoltage, \
    PVEVSEPresentCurrent, EnergyTransferModeEnum, EnergyTransferMode, \
    ACEVSEChargeParameter, PVEVSENominalVoltage, UnitSymbol, \
    PVEVSEMaxCurrent, SAScheduleTuple, PMaxScheduleEntry, PVPMax, \
    RelativeTimeInterval, DCEVSEChargeParameter, EVSENotification, \
    SAScheduleTupleEntry, PMaxScheduleEntryDetails, MeterInfo as MeterInfoV2, \
    SalesTariff, SalesTariffEntry
...
class SimEVSEController(EVSEControllerInterface):
    ...
    def get_sa_schedule_list(self,
        ...
        sa_schedule_tuple_entry = \
            SAScheduleTupleEntry(sa_schedule_tuple_id=1,
    ...
    def get_ac_evse_status(self) -> ACEVSEStatus:
        ...
        return ACEVSEStatus(notification_max_delay=0,
    ...
    def get_ac_evse_charge_parameter(self) -> ACEVSEChargeParameter:
        ...
        evse_nominal_voltage = PVEVSENominalVoltage(multiplier=0,
                                                    value=400,
                                                    unit=UnitSymbol.VOLTAGE)
        evse_max_current = PVEVSEMaxCurrent(multiplier=0,
                                            value=32,
                                            unit=UnitSymbol.AMPERE)
        return ACEVSEChargeParameter(ac_evse_status=self.get_ac_evse_status(),
    ...
    def get_dc_evse_status(self) -> DCEVSEStatus:
        ...
        return DCEVSEStatus(evse_notification=EVSENotification.NONE,
