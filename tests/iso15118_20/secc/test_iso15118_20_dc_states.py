        ...
        [
            (
                ...
                ScheduledDCChargeLoopResParams(
                    ...
                    evse_minimum_charge_power=RationalNumber(exponent=-2, value=30000),
                    evse_maximum_charge_current=RationalNumber(
                        exponent=-2, value=30000
                    ),
                    evse_maximum_voltage=RationalNumber(exponent=-2, value=30000),
                ),
                ServiceV20.DC,
                ControlMode.SCHEDULED,
                None,
                EVSEDataContext(
                    ...
                    evse_min_charge_power=300,
                    evse_max_charge_current=300,
                    evse_max_voltage=300,
                ),
            ),
            (
                DynamicDCChargeLoopReqParams(
                ...
                DynamicDCChargeLoopRes(
                    ...
                    evse_minimum_charge_power=RationalNumber(exponent=0, value=30000),
                    evse_maximum_charge_current=RationalNumber(exponent=0, value=30000),
                    evse_maximum_voltage=RationalNumber(exponent=0, value=30000),
                ),
                ServiceV20.DC,
                ControlMode.DYNAMIC,
                None,
            ...
            (
                ...
                BPTScheduledDCChargeLoopResParams(
                    ...
                    evse_maximum_voltage=RationalNumber(exponent=-2, value=30000),
                    evse_max_discharge_power=RationalNumber(exponent=-2, value=30000),
                    evse_min_discharge_power=RationalNumber(exponent=-2, value=30000),
                    evse_max_discharge_current=RationalNumber(exponent=-2, value=30000),
                    evse_min_voltage=RationalNumber(exponent=-2, value=30000),
                ),
                ServiceV20.DC_BPT,
                ControlMode.SCHEDULED,
                None,
                EVSEDataContext(
                    ...
                    evse_max_charge_current=300,
                    evse_max_voltage=300,
                    evse_max_discharge_power=300,
                    evse_min_discharge_power=300,
                    evse_max_discharge_current=300,
                    evse_min_voltage=300,
                ),
            ),
            (
                BPTDynamicDCChargeLoopReqParams(
                ...
                BPTDynamicDCChargeLoopRes(
                    ...
                    evse_maximum_voltage=RationalNumber(exponent=0, value=30000),
                    evse_max_discharge_power=RationalNumber(exponent=0, value=30000),
                    evse_min_discharge_power=RationalNumber(exponent=0, value=30000),
                    evse_max_discharge_current=RationalNumber(exponent=0, value=30000),
                    evse_min_voltage=RationalNumber(exponent=0, value=30000),
                ),
                ServiceV20.DC_BPT,
                ControlMode.DYNAMIC,
                None,
                EVSEDataContext(
                    ...
                    evse_max_voltage=30000,
                    evse_max_discharge_power=30000,
                    evse_min_discharge_power=30000,
                    evse_max_discharge_current=30000,
                    evse_min_voltage=30000,
                ),
            ),
        ],
    )
