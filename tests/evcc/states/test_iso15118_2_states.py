...
class TestEvScenarios:
    ...
    async def test_current_demand_to_current_demand(self):
        ...
        await current_demand.process_message(message=get_v2g_message_current_demand_res())
    ...
    async def test_power_delivery_to_welding_detection_when_charge_progress_is_stop(
        ...
        await power_delivery.process_message(message=get_v2g_message_power_delivery_res())
