import pytest
from iso15118.shared.validators import validate_bytes_value_range, one_field_must_be_set
...
def test_one_field_must_be_set():
    ...
    with pytest.raises(ValueError):
        two_values_set = {"ac_ev_charge_parameter": 123,
                          "dc_ev_charge_parameter": 321}
