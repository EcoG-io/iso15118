...
- bumped to version 0.4.0 by @tropxy

### Fixed

- fixed: converted debug messages to info by @tropxy
- setting of the logger level based on the .env file info by @tropxy
- Updated the README with the ability to set MESSAGE_LOG_JSON and MESSAGE_LOG_EXI by @tropxy

### Removed

- Removed aioredis dependency as it is not used by @tropxy
